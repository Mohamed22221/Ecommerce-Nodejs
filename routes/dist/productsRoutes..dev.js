...
productsRoutes.route("/:id").get(_productsController.getProduct).put(_verifyToken["default"], _productsController.updateProduct)["delete"](_verifyToken["default"], _productsController.deleteProduct);
